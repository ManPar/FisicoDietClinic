package com.fisicodietclinic.fisicodietclinic.utils;
...
@SuppressWarnings("unused")
    public class behaviorkimaaki extends CoordinatorLayout.Behavior<TextView> {
        ...
        public behaviorkimaaki(Context context, AttributeSet attrs) {
            mContext = context;
